...
export const MemoryReact = () => {
  // массив src img
  const cardImages = [
    { src: require("../img/card1-1.png") },
    { src: require("../img/card2-1.png") },
    { src: require("../img/card3-1.png") },
    { src: require("../img/card4-1.png") },
    { src: require("../img/card5-1.png") },
    { src: require("../img/card6-1.png") },
    { src: require("../img/card7-1.png") },
    { src: require("../img/card8-1.png") },
    { src: require("../img/card9-1.png") },
